...
# file in
csv_file =      '/Users/songweizhi/Desktop/Enrichment_analysis_sponge/COG/COG_enrichment_analysis.csv'
...
for column in column_list:
    ...
    if n >= 2:
        ...
        print('Processing %s/%s' % (n, len(column_list)))
...
output_test_handle.write('COG\tsponge\tDectected_pct\tseawater\tDectected_pct\tP_value\tP_value_adjusted\n')
